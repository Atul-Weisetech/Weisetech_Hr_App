...
export default function ManageLeaveRequestScreen() {
  const { leaveRequests, updateLeaveStatus } = useContext(AppStoreContext);

  return (
    <Screen>
      <Card style={{ marginBottom: 12 }}>
        <Text style={styles.title}>Manage Leave Request</Text>
        <Text style={styles.subtitle}>Approve or reject leave requests.</Text>
      </Card>
