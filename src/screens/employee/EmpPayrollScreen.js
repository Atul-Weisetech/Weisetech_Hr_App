...
export default function EmpPayrollScreen() {
  ...
  const myPayrolls = payrolls.filter(p => String(p.employeeId) === myEmployeeId);
            ...
            <View key={p.id} style={styles.payCard}>
              <View style={styles.payHeader}>
                ...
                <View style={styles.netBadge}>
                  <Text style={styles.netAmount}>₹{net.toLocaleString('en-IN')}</Text>
              ...
              <View style={styles.breakdownRow}>
                <View style={styles.breakdownItem}>
                  ...
                  <Text style={styles.breakdownValue}>₹{p.basic.toLocaleString('en-IN')}</Text>
                </View>
