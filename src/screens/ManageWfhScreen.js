...
const WfhCard = React.memo(({ item, onApprove, onReject }) => {
  ...
  return (
    <View style={styles.card}>
      ...
      {/* Approve / Reject — only for actionable statuses */}
      {canAct && (
...
export default function ManageWfhScreen() {
  ...
  const renderItem = useCallback(
    ({ item }) => <WfhCard item={item} onApprove={onApprove} onReject={onReject} />,
    [onApprove, onReject],
  );
